...
import (
	...
	exohood "github.com/exohood/exohood-smart-chain"
	"github.com/exohood/exohood-smart-chain/common"
	"github.com/exohood/exohood-smart-chain/common/hexutil"
	"github.com/exohood/exohood-smart-chain/core/types" 
	"github.com/exohood/exohood-smart-chain/rpc"
)
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, exohood.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*exohood.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (exohood.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q exohood.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q exohood.FilterQuery, ch chan<- types.Log) (exohood.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q exohood.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg exohood.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg exohood.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg exohood.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg exohood.CallMsg) (uint64, error) {
...
func toCallArg(msg exohood.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *exohood.SyncProgress {
	if p == nil {
		return nil
	}
	return &exohood.SyncProgress{
