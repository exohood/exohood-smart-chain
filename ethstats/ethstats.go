...
import (
	...
	"github.com/exohood/exohood-smart-chain/common/mclock"
	"github.com/exohood/exohood-smart-chain/consensus"
	"github.com/exohood/exohood-smart-chain/core"
	"github.com/exohood/exohood-smart-chain/core/types"
	ethproto "github.com/exohood/exohood-smart-chain/eth/protocols/eth"
	"github.com/exohood/exohood-smart-chain/event"
	"github.com/exohood/exohood-smart-chain/les"
	"github.com/exohood/exohood-smart-chain/log"
	"github.com/exohood/exohood-smart-chain/miner"
	"github.com/exohood/exohood-smart-chain/node"
	"github.com/exohood/exohood-smart-chain/p2p"
...
type backend interface {
	...
	SyncProgress() exohood.SyncProgress
}
...
func (s *Service) login(conn *connWrapper) error {
	...
	if info := infos.Protocols[p.Name]; info != nil {
		...
		network = fmt.Sprintf("%d", infos.Protocols["exo-les"].(*les.NodeInfo).Network)
	}
	auth := &authMsg{
		ID: s.node,
		Info: nodeInfo{
